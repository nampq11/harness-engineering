...
Reference for Claude when explaining or adapting enforcement scripts installed by `/harness-engineering`. All scripts live in `scripts/lib/` after installation and are invoked by git hooks.
